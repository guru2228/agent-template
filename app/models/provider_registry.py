...
from .providers.azure_openai import register_azure_openai_models, AzureOpenAIModels
...
class ProviderConstants:
    ...
    AZURE_OPENAI: Literal["azure_openai"] = "azure_openai"
...
PROVIDER_CONFIG: Dict[str, ProviderConfigType] = {
    ...
    ProviderConstants.AZURE_OPENAI: {
        "register_function": register_azure_openai_models,
        "models_enum": AzureOpenAIModels,
        "synonyms": ["azure"],
    },
